  ...
  'use strict';
    ...
    $.extend( Plugin.prototype, {
      ...
      renderMarkup: function() {
        var $container =                    $('<div class="image-marker-container" id="CaptureImage"></div>');
        var $left_box_wrapper =             $('<div class="image-marker-container__box image-marker-container__box--left"></div>');
          ...
          var $image = $('<img class="image-marker-container__img" id="imageMap"/>');
      ...
      addTextbox: function(marker) {
        ...
        $text_box.append($title);
          ...
          var $content = $(' <input type="text" style=" border: 1px solid #ccc;" placeholder="Description">');  /* <textarea></textarea> */
