...
namespace TM.RestHour.Models
{
    public class MedicalAdvise
    {
		...
		private List<ExaminationForMedicalAdvise> examinationForMedicalAdvises;

		public MedicalAdvise()
		{
			examinationForMedicalAdvises = new List<ExaminationForMedicalAdvise>();
			this.ExaminationForMedicalAdviseList = examinationForMedicalAdvises;
		}

		public List<ExaminationForMedicalAdvise> ExaminationForMedicalAdviseList { get; set; }
	}
}